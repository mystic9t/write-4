    ...
    <main className="min-h-screen bg-dark-950 text-white">
      <div className="max-w-6xl mx-auto px-4 py-24 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex gap-4 flex-col sm:flex-row animate-slide-up">
          ...
          <a
            href="https://github.com/your-username/ai-text-editor"
            target="_blank"
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="p-6 border border-dark-800 rounded-xl bg-dark-900/50 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:bg-dark-800/50">
